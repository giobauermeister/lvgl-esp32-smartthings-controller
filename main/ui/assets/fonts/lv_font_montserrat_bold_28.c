 ...
 * Size: 28 px
 * Bpp: 4
 * Opts: --font Montserrat-Bold.ttf --size 28 --bpp 4 --no-compress --format lvgl --range 0x20-0x7F,0xB0 --lv-font-name lv_font_montserrat_bold_28 -o ./lv_font_montserrat_bold_28.c
 ******************************************************************************/
